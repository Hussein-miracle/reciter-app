<template>
<!-- Auth Modal -->
  <div class="fixed z-10 inset-0 overflow-y-auto" :class="{hidden : !modalShow }"   id="modal">
      ...
      <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden
        ...
        <div class="py-4 text-left px-6">
          ...
          <div class="flex justify-between items-center pb-4">
            ...
            <!-- Modal Close Button -->
            <div class="modal-close cursor-pointer z-50" v-on:click.prevent="toggleAuthModal" v-on:keyDown.prevent="toggleAuthModal">
